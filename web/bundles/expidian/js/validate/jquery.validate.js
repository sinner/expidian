 ...
 *
 * $Id: jquery.validate.js 81 2010-05-19 21:56:16Z admin $
 *
...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Por favor corrija el valor ingresado en este campo.",
		email: "Por favor ingrese una Direccion de E-mail Válida.",
		url: "Por favor ingrese una URL Válida.",
		date: "Por favor ingrese una Fecha Válida.",
		dateISO: "Por favor ingrese una Fecha Válida (ISO).",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "Por favor ingrese un numero valido enter a valid number.",
		numberDE: "Bitte geben Sie eine Nummer ein.",
		digits: "Por favor ingrese solo Dígitos",
		creditcard: "Por favor ingrese dígitos válidos de la Tarjeta de crédito.",
		equalTo: "Por favor ingrese el mismo valor de nuevo. Los campos no coinciden.",
		...
		max: $.validator.format("Ingese un valor menor a {0} ."),
		min: $.validator.format("Ingese un valor mayor a {0}.")
	},
	...
	prototype: {
		...
		idOrName: function(element) {
			return this.groups[element.id] || (this.checkable(element) ? element.id : element.name || element.id);
		},
